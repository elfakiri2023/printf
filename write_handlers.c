...
/**
 * handle_char_write - Prints a string
 * @c: char types.
...
/**
 * write_a_number - Prints a string
...
/**
 * write_a_num - Write a number using a bufffer
...
/**
 * write_a_unsgnd - Writes an unsigned number
...
/**
 * write_a_pointer - Write a memory address
