...
/**
 * append_hexa_codee - Append ascci in hexadecimal code to buffer
 * @buffer: Array of chars.
 * @i: Index at which to start appending.
 * @ascii_code: ASSCI CODE.
 * Return: Always 3
 */
int append_hexa_codee(char ascii_code, char buffer[], int i)
{
...
/**
 * check_is_digit - Verifies if a char is a digit
 * @c: Char to be evaluated
 *
...
/**
 * convert_size_numberr - Casts a number to the specified size
