...
int print_a_int(va_list ap, params_t *params)
{
	...
	if (params->l_modifier)
		...
		l = (int)va_arg(ap, int);
	return (print_a_number(convert(l, 10, 0, params), params));
}

/**
 * print_a_string - prints string
 * @ap: argument pointer
 * @params: the parameters struct
 *
 * Return: number chars printed
...
/**
 * print_an_S - custom format specifier
 * @ap: argument pointer
 * @params: the parameters struct
 *
 * Return: number chars printed
