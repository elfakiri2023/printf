...
int print_a_pointer(va_list types, char buffer[], int flags,
...
int reverse_print(va_list types, char buffer[], int flags, int width,
...
int print_a_rot13string(va_list types, char buffer[], int flags,
int width, int precision, int size)
{
	char x;
	char *str;
